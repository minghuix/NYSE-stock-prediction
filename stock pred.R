...
#### Test if url exists
## ABCD
stock_names<-read.table('C:\\Users\\mxiong\\Downloads\\kaggle\\stock\\A_D.txt',header = TRUE,sep = "\t",quote=NULL)
...
write.table(test_df, "C:\\Users\\mxiong\\Downloads\\kaggle\\stock\\url test results\\MyData1.csv", sep=",", 
            row.names=FALSE, col.names=FALSE)

## EFGH
stock_names2<-read.table('C:\\Users\\mxiong\\Downloads\\kaggle\\stock\\E_H.txt',header = TRUE,sep = "\t",quote=NULL)
ex_list2 <- c('-',"\\.")
...
write.table(test_df2, "C:\\Users\\mxiong\\Downloads\\kaggle\\stock\\url test results\\MyData2.csv", sep=",", 
            row.names=FALSE, col.names=FALSE)

## IJKL
stock_names3<-read.table('C:\\Users\\mxiong\\Downloads\\kaggle\\stock\\I_L.txt',header = TRUE,sep = "\t",quote=NULL)
ex_list2 <- c('-',"\\.")
...
write.table(test_df3, "C:\\Users\\mxiong\\Downloads\\kaggle\\stock\\url test results\\MyData3.csv", sep=",", 
            row.names=FALSE, col.names=FALSE)

## MNOP
stock_names4<-read.table('C:\\Users\\mxiong\\Downloads\\kaggle\\stock\\M_P.txt',header = TRUE,sep = "\t",quote=NULL)
ex_list2 <- c('-',"\\.")
...
write.table(test_df4, "C:\\Users\\mxiong\\Downloads\\kaggle\\stock\\url test results\\MyData4.csv", sep=",", 
            row.names=FALSE, col.names=FALSE)

## QRST
stock_names5<-read.table('C:\\Users\\mxiong\\Downloads\\kaggle\\stock\\Q_T.txt',header = TRUE,sep = "\t",quote=NULL)
ex_list2 <- c('-',"\\.")
...
write.table(test_df5, "C:\\Users\\mxiong\\Downloads\\kaggle\\stock\\url test results\\MyData5.csv", sep=",", 
            row.names=FALSE, col.names=FALSE)

## UVWX
stock_names6<-read.table('C:\\Users\\mxiong\\Downloads\\kaggle\\stock\\U_X.txt',header = TRUE,sep = "\t",quote=NULL)
ex_list2 <- c('-',"\\.")
...
write.table(test_df6, "C:\\Users\\mxiong\\Downloads\\kaggle\\stock\\url test results\\MyData6.csv", sep=",", 
            row.names=FALSE, col.names=FALSE)
...
stock_all <- rbind(test_df, test_df2, test_df3,test_df4,test_df5,test_df6,test_df7)
...
head(stockdata)
write.table(stockdata, "C:\\Users\\mxiong\\Downloads\\kaggle\\stock\\combineddata.csv", sep=",", 
            row.names=FALSE, col.names=c("stock","data1","data2","data3", "data4", "data5", "data6",
                                         "data7", "data8", "data9", "data10", "data11", "data12"))
### data cleaning ###
raw_data_x = read.csv("C:\\Users\\mxiong\\Downloads\\kaggle\\stock\\combineddata.csv",sep = ",")
...
write.csv(final_dataframe, "C:\\Users\\mxiong\\Downloads\\kaggle\\stock\\stock_clean_v1.csv")
test_final<- read.csv("C:\\Users\\mxiong\\Downloads\\kaggle\\stock\\stock_clean_v1.csv",header = TRUE,sep = ',')
...
write.csv(test_final_2, "C:\\Users\\mxiong\\Downloads\\kaggle\\stock\\stock_clean_v2.csv")
...
na_count$na_count<-na_count$na_count/2337
